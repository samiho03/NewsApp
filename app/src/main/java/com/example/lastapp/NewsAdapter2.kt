...
class NewsAdapter2(
...
) : RecyclerView.Adapter<NewsAdapter2.NewsViewHolder>() {
    ...
    class NewsViewHolder(view: View) : RecyclerView.ViewHolder(view) { // Fixed class name
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsViewHolder { // Fixed return type
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.my_news_items, parent, false)
        return NewsViewHolder(view) // Fixed constructor
    }

    // Binds data to the views in the ViewHolder
    override fun onBindViewHolder(holder: NewsViewHolder, position: Int) { // Fixed parameter type
